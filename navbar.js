function Navbar (){
    ...
    return  `<nav class="navbar navbar-dark bg-info  navbar-expand-sm p-3">
    ...
    <ul class="navbar-nav ml-auto " style="color: white;">
        <li class="nav-item active list-inline-item"><a class="nav-link text-light" href="">Recipe of the day</a></li>
